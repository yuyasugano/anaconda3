...
RUN pip install --upgrade pip setuptools importlib-metadata && \
    pip install TA-Lib backtesting pandas-highcharts mpl_finance optuna pandas-datareader python-coinmarketcap python-binance python-dotenv boto3 binance binance-connector papermill && \
